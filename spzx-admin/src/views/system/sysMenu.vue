...
<!--    <el-button type="success" size="small" @click="">折叠全部</el-button>-->
<!--    <el-button type="success" size="small" @click="">展开全部</el-button>-->
  </div>
...
//   this.isExpandAll = expandedRows
// }
// const toggleExpandAll = ()=>{
//   this.isExpandAll = !this.isExpandAll;
//   this.toggleRowExpansionAll(this.tableData, this.isExpandAll);
// }
// const toggleRowExpansionAll = (data, isExpandAll)=>{
//
//   data.forEach((item) => {
//     this.$refs.tableTreeRef.toggleRowExpansion(item, isExpandAll);
